...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg-page p-4">
      <div className="bg-card-surface rounded-2xl border border-border p-8 sm:p-12 w-full max-w-xl shadow-sm animate-fade-in">
        {/* Logo/Brand */}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                disabled={loginMutation.isPending}
                className={`w-full px-4 py-3 pr-12 bg-bg-default border rounded-xl text-sm text-text-default placeholder:text-text-disabled focus:outline-none focus:border-trove-green focus:bg-card-surface transition-colors ${errors.password ? 'border-negative' : 'border-border'
                  }`}
              />
              <button
                type="button"
                ...
                disabled={loginMutation.isPending}
                className="absolute right-4 top-1/2 -translate-y-1/2 text-text-disabled hover:text-text-neutral transition-colors focus:outline-none"
        ...
        <div className='items-center text-center py-5'>
          <p className='text-trove-green text-[12px] my-4'>Forgot password?</p>
          ...
          >
            ...
            <p className='text-[12px] text-text-default'>Create a Trove Account</p>
